...
Secondly, with a few exceptions virtually all Linux distributions are free to use. Not only that, but almost all of the software that you use on Linux is also free. This is definitely different from Mac.  That said, just like the Mac, the software you used on Windows won't work on Linux. At least not directly. There are some emulators that allows _some_ software to work, but I wouldn't depend on that!
