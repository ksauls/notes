...
[params]
  ...
  # the list of set content will show up on your i/bilndex page (baseurl).
...
enableGitInfo = true
  ...
  # setitle for the table of contents
  # can be overridden in a page's front-matter
...
[languages]
  [languages.en]
    ...
    [languages.en.params]
      subtitle = "A place for random wonderings"
      owner = "kevin sauls"
	  copyright = "2025"
      keywords = ""
      menuMore = "Show more"
